...
/*@}*/
int av_printf_byte(char* tag,char* ptr,int len)
{
    ...
    if(tag)
    {
        //av_log(NULL,AV_LOG_INFO,"umplayer %s:**************1*************",tag);
        av_log(NULL,AV_LOG_DEBUG,"umplayer %s:%s",tag,tmp);
        //av_log(NULL,AV_LOG_INFO,"umplayer %s:**************2*************",tag);
    }
    else{
        //av_log(NULL,AV_LOG_INFO,"umplayer av_printf_byte:**************1*************");
        av_log(NULL,AV_LOG_DEBUG,"umplayer av_printf_byte:%s",tmp);
        //av_log(NULL,AV_LOG_INFO,"umplayer av_printf_byte:**************2*************");
    }
                                                              ...
                                                              int size))
{
    ...
    while (len < size_min) {
        if (ff_check_interrupt(&h->interrupt_callback))
            return AVERROR_EXIT;
        //av_log(NULL,AV_LOG_DEBUG,"retry_transfer_wrapper %s",h->prot->name);
