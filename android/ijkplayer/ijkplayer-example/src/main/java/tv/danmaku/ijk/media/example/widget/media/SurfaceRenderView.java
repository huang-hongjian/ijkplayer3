...
public class SurfaceRenderView extends SurfaceView implements IRenderView {
    ...
    private Rect video_rect;
    private boolean rect_change;
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        rect_change = changed;
        video_rect.bottom = bottom;
        video_rect.right = right;
        video_rect.top = top;
        video_rect.left =left;
    }
    @Override
    public Rect getRect()
    {
    ...
    private static final class InternalSurfaceHolder implements IRenderView.ISurfaceHolder {
        ...
        public void bindToMediaPlayer(IMediaPlayer mp) {
            if (mp != null) {
                ...
                Log.e(TAG, "bindToMediaPlayer  mSurfaceHolder="+mSurfaceHolder);
    ...
    private static final class SurfaceCallback implements SurfaceHolder.Callback {
        ...
        public void surfaceCreated(SurfaceHolder holder) {
            ...
            mWidth = 0;
            mHeight = 0;
            Log.e(TAG, "surfaceCreated  mSurfaceHolder="+mSurfaceHolder);
            ISurfaceHolder surfaceHolder = new InternalSurfaceHolder(mWeakSurfaceView.get(), mSurfaceHolder);
            Log.e(TAG, "surfaceCreated  surfaceHolder="+surfaceHolder);
