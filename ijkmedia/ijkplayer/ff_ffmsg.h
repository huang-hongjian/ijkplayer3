...
#define FFP_MSG_VIDEO_FIRST_FRAME           1050    /* 播放器播放上报的第一帧*/
#define FFP_MSG_SEEK_AFTER_FIRST_FRAME      1051    /* seek之后解码器上报的第一帧*/
#define FFP_MSG_BLURREDSCREEN_START  1052     //花屏开始事件
#define FFP_MSG_BLURREDSCREEN_END   1053      //花屏开始事件
#define FFP_MSG_STUTTER       1054           	//卡顿事件
#define FFP_MSG_UNDERFLOW_START  1055    		//缓冲区开始欠载
#define FFP_MSG_UNDERFLOW_END     	1056	//缓冲区结束欠载
